...
const Cursos = () => {
  ...
  return (
    <div style={{ padding: '4rem 2rem', maxWidth: '1200px', margin: '0 auto', textAlign: 'center' }}>
      <h1 style={{ color: 'var(--color-primary)' }}>Cursos Cortos y Especializados</h1>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '2rem' }}>
          {cursos.map(c => (
            <div key={c.id} className="glass-panel" style={{ padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <p style={{ color: 'var(--text-main)' }}>{c.descripcion || "Curso formativo impartido por la academia."}</p>
